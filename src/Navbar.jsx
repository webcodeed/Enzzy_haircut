    ...
    return (
            <nav className="fixed text-gray-100 top-0 w-full backdrop-blur-md font-serif bg-white/10 border-b border-white/20 shadow-md md:p-4 md:mx-auto rounded-xl z-50 " >
                <div className=" mx-auto lg:px-8 flex md:flex-wrap justify-between items-center md:gap-5 ">
                    ...
                    {/* Navigation  */}
                    <div
                        className={`md:flex md:flex-wrap md:grow-2 md:gap-5 text-center space-y-3 md:items-center absolute opacity-0 md:opacity-100 md:z-auto md:static md:translate-x-0 w-full md:w-auto h-screen md:h-auto transition-all ease-in-out duration-300 ${
                          isMenu
                      ...
                      {/* Navigate  */}
                        <div className=" flex flex-col md:flex-row justify-evenly md:grow md:my-auto text-2xl md:text-base font-medium leading-snug">
                            {navigate.map((item) => (
                    ...
                    {/* CTA  Button */}
                            <button className="hover:bg-yellow-600 py-3 bg-yellow-500  text-black font-semibold rounded-xl shadow-md active:scale-90 transition-all duration-300" >
