...
function footer() {
    ...
    return (
        <footer className=" bg-black w-full h-fit ">
            <div className="text-gray-300 mx-auto px-5 py-10 sm:w-8/10 lg:w-8/10 md:w-full md:flex md:flex-col ">
                <div className=" grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 md:justify-items-center gap-y-5 mb-10 lg:my-20">
                    ...
                    <div className=" col-start-1 md:col-start-3 " >
                        ...
                        <div className="flex flex-col">
                            <a className="underline text-yellow-600 active:text-yellow-800 underline-offset-4" href="tel:+2349057449447">+234 905 744 9447</a>
                            <a className="underline text-yellow-600 active:text-yellow-800 underline-offset-4" href="mailto:otegbadee@gmail.com">
                                otegbadee@gmail.com
                            </a>
                        </div>
                    </div>
                    ...
                    <div className=" justify-self-end row-start-2 lg:row-start-1  row-span-2 lg:row-span-1 col-start-2 md:col-start-2 lg:col-start-5 md:col-span-2 md:justify-self-center flex flex-col">
                        ...
                        {navigate.map((item) => (
                            <Link className="underline text-yellow-600 active:text-yellow-800 underline-offset-4" to={item.url} key={item.name}>
                                {item.name}
                            </Link>
                        ))}
                    </div>
